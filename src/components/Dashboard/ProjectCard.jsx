    ...
    <div className='rounded-md shadow-md p-6'>
      ...
      <div>
        <div className='flex justify-between'>
          <div>
            <h3 className="text-[#050504] font-bold text-xl">{title}</h3>
            <p className="text-xs text-[#707066] pt-3">{category}</p>
          </div>
          <span>
        ...
        <div className='space-y-2'>
          <span className="bg-[#DBE2F0] py-1 px-2 rounded-md">{status}</span> <br/> <br />
          <span className="bg-[#DBE2F0] py-1 px-2 rounded-md">Next milestone: {milestone}</span>
        </div>
      </div>
